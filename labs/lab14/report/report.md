...
![Задание 1](image/Screenshot from 2024-05-03 10-18-04.png){#fig:001 width=100%}
...
![Задание 2](image/Screenshot from 2024-05-03 10-20-46.png){#fig:002 width=100%}

3. Написать командный файл, создающий указанное число файлов, пронумерованных
последовательно от 1 до 𝑁 (например 1.tmp, 2.tmp, 3.tmp,4.tmp и т.д.). Число файлов,
которые необходимо создать, передаётся в аргументы командной строки. Этот же командный файл должен уметь удалять все созданные им файлы (если они существуют).

![Задание 3](image/Screenshot from 2024-05-03 10-22-01.png){#fig:003 width=100%}
...
![Задание 4](image/Screenshot from 2024-05-03 10-22-38.png){#fig:004 width=100%}
